...
namespace ThermostatDataGenerator
{
    ...
    {        
        ...
        {
            if (args.Length == 0)
                throw new Exception("Pass a connectionstring to the Event Hub");
        ...
        {
            int indexOfPart = connectionString.IndexOf(partName);
            int indexOfPartEnd = connectionString.IndexOf(";", indexOfPart);
